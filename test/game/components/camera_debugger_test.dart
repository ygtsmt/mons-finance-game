  ...
  group('CameraDebugger', () {
    ...
    testWithGame(
      ...
      (game) async {
        ...
        controller.onKeyEvent(keyDown as KeyEvent, {LogicalKeyboardKey.keyW});
        ...
        controller.onKeyEvent(keyUp as KeyEvent, {LogicalKeyboardKey.keyW});
        cameraDebugger.update(0.1);
    ...
    testWithGame('moves down when S is pressed', _TestGame.new, (game) async {
      ...
      controller.onKeyEvent(keyDown as KeyEvent, {LogicalKeyboardKey.keyS});
      ...
      controller.onKeyEvent(keyUp as KeyEvent, {LogicalKeyboardKey.keyS});
      cameraDebugger.update(0.1);
    ...
    testWithGame('moves left when A is pressed', _TestGame.new, (game) async {
      ...
      controller.onKeyEvent(keyDown as KeyEvent, {LogicalKeyboardKey.keyA});
      ...
      controller.onKeyEvent(keyUp as KeyEvent, {LogicalKeyboardKey.keyA});
      cameraDebugger.update(0.1);
    ...
    testWithGame('moves left when D is pressed', _TestGame.new, (game) async {
      ...
      controller.onKeyEvent(keyDown as KeyEvent, {LogicalKeyboardKey.keyD});
      ...
      controller.onKeyEvent(keyUp as KeyEvent, {LogicalKeyboardKey.keyD});
      cameraDebugger.update(0.1);
    ...
    testWithGame('increases speed when M is pressed', _TestGame.new,
      ...
      controller.onKeyEvent(keyDown as KeyEvent, {LogicalKeyboardKey.space});
      ...
      controller.onKeyEvent(keyUp as KeyEvent, {LogicalKeyboardKey.keyM});
      cameraDebugger.update(0.1);
